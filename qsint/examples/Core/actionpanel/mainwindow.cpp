    ...
    ui(new Ui::MainWindow)
{
    ...
    auto edit_toggle = new QSint::ActionLabel(this);
    edit_toggle->setText("[Edit]");
    edit_toggle->setSizePolicy(QSizePolicy::Minimum, QSizePolicy::Preferred);

    connect(edit_toggle, &QSint::ActionLabel::clicked,
            []() {
              qDebug() << "clicked.........";
            });
    group2->headerLayout()->insertWidget(1, edit_toggle);
    group2->headerLayout()->addStretch(0);
